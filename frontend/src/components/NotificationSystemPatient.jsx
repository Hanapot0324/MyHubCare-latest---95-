...
const NotificationSystemPatient = ({ socket }) => {
                        ...
                        try {
                            ...
                            if (appointmentResponse.ok) {
                                ...
                                if (appointmentData.success && appointmentData.data) {
                                    // Attach appointment details for formatted display
                                    return {
                                        ...notif,
    ...
    const formatNotificationMessage = (notification, appointmentDetails = null) => {
        // Use appointmentDetails from notification if available, otherwise use passed parameter
        const details = notification.appointmentDetails || appointmentDetails;
